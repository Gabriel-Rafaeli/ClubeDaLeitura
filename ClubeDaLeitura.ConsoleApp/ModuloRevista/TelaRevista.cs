...
namespace ClubeDaLeitura.ConsoleApp.ModuloRevista
{
    ...
    {
        public RepositorioCaixa cadastroCaixa = null;
        ...
        public void EditarRevista()
        {
            ...
            foreach (var revista in cadastroRevista.Revistas)
            {
                ...
                {
                    foreach (var caixa in cadastroCaixa.ListaDeCaixas)
                    {
                        if (revista.CaixaOndeEstaGuardada.Id == caixa.Id)
                        {
                            caixa.ListaRevistasNasCaixas.Remove(revista);
                        }
                    }
                }
            }
        ...
        public Revista ObterRevista()
        {
            ...
            foreach (Caixa c in cadastroCaixa.ListaDeCaixas)
            {
                if (idDaCaixa == c.Id)
                {
                    caixa = c;
