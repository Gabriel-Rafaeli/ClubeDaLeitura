...
namespace ClubeDaLeitura.ConsoleApp.ModuloEmprestimo
{
    ...
    {
        public RepositorioRevista cadastroRevista = null;
        public RepositorioAmigo cadastroAmigo = null;
        public RepositorioEmprestimo cadastroEmprestimo = null;
        ...
        public void ListarEmprestimo()
        {
            ...
            {
                Console.WriteLine("{0,-5}|{1,-11}|{2,-11}|{3,-20}|{4,-18}|{5,-10}|", emprestimo.Id, emprestimo.AmigoQuePegouARevista.Nome, emprestimo.RevistaEmprestada.TipoColecao, emprestimo.DataEmprestimo, emprestimo.DataDevolucao, emprestimo.Status);
            }
        ...
        public Emprestimo ObterEmprestimo()
        {
            ...
            foreach (Amigo a in cadastroAmigo.ListaAmigos)
            {
                if (idAmigo == a.Id)
                {
                    amigo = a;
        ...
        public void AlterarStatus()
        {
            ...
            foreach (Emprestimo e in cadastroEmprestimo.ListaDeEmprestimos)
            {
                if (idFechar == e.Id)
                {
                    emprestimo = e;
